...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.a; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.b; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.c; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.d; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.e; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.h; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static const int clocks = 0;
  static uint8_t read(const cpu &pCpu) { return pCpu.mRegister.l; };
  static void write(cpu &pCpu, const uint8_t pValue) {
...
public:
  static uint16_t read(cpu &pCpu) { return pCpu.mRegister.af(); };
  static void write(cpu &pCpu, const uint16_t pValue) {
...
public:
  static uint16_t read(cpu &pCpu) { return pCpu.mRegister.bc(); };
  static void write(cpu &pCpu, const uint16_t pValue) {
...
public:
  static uint16_t read(cpu &pCpu) { return pCpu.mRegister.de(); };
  static void write(cpu &pCpu, const uint16_t pValue) {
...
public:
  static uint16_t read(cpu &pCpu) { return pCpu.mRegister.sp; };
  static void write(cpu &pCpu, const uint16_t pValue) {
...
public:
  static uint16_t read(cpu &pCpu) { return pCpu.mRegister.hl(); };
  static void write(cpu &pCpu, const uint16_t pValue) {
