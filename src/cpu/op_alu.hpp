...
template <int B> class op_bit : op_unary {
public:
  static uint8_t exec(cpu &pCpu, const uint8_t pValue) {
...
template <int B> class op_set : op_unary {
public:
  static uint8_t exec(cpu &pCpu, const uint8_t pValue) {
...
template <int B> class op_res : op_unary {
public:
  static uint8_t exec(cpu &pCpu, const uint8_t pValue) {
    uint8_t result = (~(1 << B)) & pValue;
    return result;
...
template <typename Op, typename R>
  requires conjunction<is_base_of<alu::op_binary, Op>,
                       is_base_of<reg::reg8, R>>::value
...
template <typename Op, typename R>
  requires conjunction<is_base_of<alu::op_unary, Op>,
                       is_base_of<reg::reg8, R>>::value
